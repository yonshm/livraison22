                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="bon_ramassage" class="form-control" id="inputCommande"
                        ...
                        <div class="col-md-6">
                            <div class=" mb-3">
                                ...
                                <input type="text" name="marchandise" class="form-control" id="inputMarchabdise"
                                    placeholder="Marchabdise">
                            </div>
                        </div>
