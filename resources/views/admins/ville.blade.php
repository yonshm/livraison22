                              ...
                              <tr class="odd">
                                ...
                                <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                      <li>
                                        <a class="dropdown-item d-flex align-items-center gap-3" href="{{route('villes.edit', $ville->id)}}">
...
<form id="formAjouterVille" action="{{ route('villes.store') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
        <div class="form-floating mb-3">
            <input type="number" step="0.01" name="frais_livraison" value="0" class="form-control" id="tb-fraiL" placeholder="Enter frais livraison">
            <label for="tb-fraiL">Frais livraison</label>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-floating mb-3">
            <input type="number" step="0.01" name="frais_retour" value="0" class="form-control" id="tb-fraisRe" placeholder="Enter frais retour">
            <label for="tb-fraisRe">Frais retour</label>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-floating mb-3">
            <input type="number" step="0.01" name="frais_refus" value="0" class="form-control" id="tb-fraisR" placeholder="Enter frais refus">
